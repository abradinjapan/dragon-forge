...
void STANDARD__code__set_inputs_in_context_buffer(ANVIL__workspace* workspace, STANDARD__offsets* anvil_offsets) {
    ...
    // write data
    ANVIL__code__cell_to_address(workspace, ANVIL__sft__always_run, STANDARD__set_inputs_in_context_buffer__input_start, ANVIL__srt__constant__cell_byte_count, STANDARD__set_inputs_in_context_buffer__input_start_address);
    ANVIL__code__cell_to_address(workspace, ANVIL__sft__always_run, STANDARD__set_inputs_in_context_buffer__input_end, ANVIL__srt__constant__cell_byte_count, STANDARD__set_inputs_in_context_buffer__input_end_address);
...
void STANDARD__code__get_outputs_from_context_buffer(ANVIL__workspace* workspace, STANDARD__offsets* anvil_offsets) {
    ...
    // perform reads
    ANVIL__code__address_to_cell(workspace, ANVIL__sft__always_run, STANDARD__get_outputs_from_context_buffer__output_start_read_address, ANVIL__srt__constant__cell_byte_count, STANDARD__get_outputs_from_context_buffer__output_start);
    ANVIL__code__address_to_cell(workspace, ANVIL__sft__always_run, STANDARD__get_outputs_from_context_buffer__output_end_read_address, ANVIL__srt__constant__cell_byte_count, STANDARD__get_outputs_from_context_buffer__output_end);
